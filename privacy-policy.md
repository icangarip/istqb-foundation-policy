Privacy Policy for ISTQB Foundation Exam
  ...
  Welcome to ISTQB Foundation Exam ("we," "our," or "us"). We are committed to protecting your privacy and ensuring transparency about how we collect,
  ...
  How It's Collected:
  - Through RevenueCat SDK when you make a purchase
  - Through Apple App Store purchase receipts
  - Stored in RevenueCat and our analytics database
  ...
  How It's Collected:
  - Automatically tracked as you use the app
  - Sent to our analytics servers (Supabase)
  - Stored with your User ID to track progress
  ...
  How It's Collected:
  - Tracked through app lifecycle events
  - Calculated from your quiz and flashcard sessions
  - Stored locally on your device and synced to our servers
  ...
  Our app does NOT display advertisements of any kind:
  - No banner ads
  - No interstitial ads
  - No video ads
  ...
  We use the following third-party services that may collect data from our app:
  ...
  Age Requirement: You must be at least 13 years old to use this app (or the age of digital consent in your country, whichever is higher)
  ...
  Data Controller: ICAN35 Apps

  EU Representative: Not required (we are outside EU)

  Data Protection Officer: Not required (under 250 employees)
